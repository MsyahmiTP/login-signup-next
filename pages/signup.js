...
export default function signup() {
    return (
        <>
    <div className="flex items-center justify-center xl:justify-center lg:justify-center ">
      <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
        <form className='border-2 border-slate-300 rounded-md pt-7 pl-4 pb-5 pr-4'>
          <div className="mb-6">
            <input
              type="text"
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <a href="#!" className="text-gray-800">Lupa Password?</a>
          </div>

          <div className="text-center lg:text-center">
            <button
              type="button"
              className="inline-block px-20 py-3 bg-violet-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-violet-700 hover:shadow-lg focus:bg-violet-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-violet-800 active:shadow-lg transition duration-150 ease-in-out">
              Masuk
            </button>
          ...
          <div className="flex flex-row items-center justify-center lg:justify-center p-3">
            <p className="text-sm font-semibold text-lg mb-0 mr-4">Masuk dengan</p>
            <button
              type="button"
